...
package viewer_swing.java.com.glavsoft.viewer;

import main.java.com.glavsoft.rfb.protocol.ProtocolSettings;
import viewer_swing.java.com.glavsoft.viewer.cli.Parser;
import viewer_swing.java.com.glavsoft.viewer.mvp.View;
import viewer_swing.java.com.glavsoft.viewer.swing.ConnectionParams;
import viewer_swing.java.com.glavsoft.viewer.swing.ParametersHandler;
import viewer_swing.java.com.glavsoft.viewer.swing.SwingConnectionWorkerFactory;
import viewer_swing.java.com.glavsoft.viewer.swing.SwingViewerWindowFactory;
import viewer_swing.java.com.glavsoft.viewer.swing.gui.ConnectionView;
...
public class Viewer extends JApplet implements Runnable, WindowListener {
    ...
    public static void viewerMain(String[] args) {
    ...
    private void setLoggingLevel(Level levelToSet) {
        final Logger appLogger = Logger.getLogger("main.java.com.glavsoft");
