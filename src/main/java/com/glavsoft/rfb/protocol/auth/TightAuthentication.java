...
import main.java.com.glavsoft.exceptions.UnsupportedSecurityTypeException;
import main.java.com.glavsoft.rfb.CapabilityContainer;
import main.java.com.glavsoft.rfb.IPasswordRetriever;
import main.java.com.glavsoft.rfb.RfbCapabilityInfo;
import main.java.com.glavsoft.rfb.protocol.state.SecurityTypeState;
...
public class TightAuthentication extends AuthHandler {
	...
	private void initTunnelling(Reader reader, Writer writer)
		...
		if (tunnelsCount > 0) {
			for (int i = 0; i < tunnelsCount; ++i) {
				...
				Logger.getLogger("main.java.com.glavsoft.rfb.protocol.auth").fine(rfbCapabilityInfo.toString());
			}
	...
	throws UnsupportedSecurityTypeException, TransportException, FatalException {
		...
		Logger.getLogger("main.java.com.glavsoft.rfb.protocol.auth").info("Auth capability accepted: " + authHandler.getName());
