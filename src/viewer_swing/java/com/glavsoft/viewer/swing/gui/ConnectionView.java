...
package viewer_swing.java.com.glavsoft.viewer.swing.gui;

import viewer_swing.java.com.glavsoft.viewer.mvp.View;
import viewer_swing.java.com.glavsoft.viewer.swing.ConnectionParams;
import viewer_swing.java.com.glavsoft.viewer.ConnectionPresenter;
import viewer_swing.java.com.glavsoft.viewer.swing.Utils;
import viewer_swing.java.com.glavsoft.viewer.swing.WrongParameterException;
...
public class ConnectionView extends JPanel implements View {
    ...
    private JButton closeBackButton;
    ...
    public ConnectionView(final WindowListener appWindowListener,
        ...
        addFormFieldRow(optionsPane, gridRow, new JLabel("Remote Host:"),
                serverNameCombo, true);
        ++gridRow;

        serverPortField = new JTextField(COLUMNS_PORT_USER_FIELD);

        addFormFieldRow(optionsPane, gridRow, new JLabel("Port:"),
                serverPortField, false);
        ++gridRow;
        ...
        view = new JFrame("New JamalVNC Connection");
...
//        view.setResizable(false);
    ...
    private void initConnectionsHistoryCombo() {
        ...
        prototypeDisplayValue.hostName = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX''";
    ...
    public void showReconnectDialog(final String title, final String message) {
        JOptionPane reconnectPane = new JOptionPane(
                message + "\nTry another connection?",
                JOptionPane.QUESTION_MESSAGE, JOptionPane.YES_NO_OPTION);
        final JDialog reconnectDialog = reconnectPane
                .createDialog(ConnectionView.this, title);
        Utils.decorateDialog(reconnectDialog);
        reconnectDialog.setVisible(true);
        if (reconnectPane.getValue() == null || (Integer) reconnectPane
                .getValue() == JOptionPane.NO_OPTION) {
...
//                forceConnectionDialog = allowInteractive;
    ...
    private JPanel createButtons() {
        ...
        closeBackButton = new JButton(BACK);
        closeBackButton.addActionListener(new ActionListener() {
        ...
        connectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String hostName = item instanceof ConnectionParams
                        ? ((ConnectionParams) item).hostName : (String) item;
                try {
                    setConnectionInProgress(true);
                    presenter.submitConnection(hostName);
                } catch (WrongParameterException wpe) {
                    if (ConnectionPresenter.PROPERTY_HOST_NAME
                            .equals(wpe.getPropertyName())) {
                        serverNameCombo.requestFocusInWindow();
                    }
                    if (ConnectionPresenter.PROPERTY_RFB_PORT_NUMBER
                            .equals(wpe.getPropertyName())) {
        ...
        optionsButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                od.initControlsFromSettings(presenter.getRfbSettings(),
                        presenter.getUiSettings(), true);
                od.setVisible(true);
                view.toFront();
            }
        });
        ...
        buttonPanel.add(closeBackButton);
        return buttonPanel;
    }
    ...
    private int createSshOptions(JPanel pane, int gridRow) {
        ...
        JPanel sshUserFieldPane = new JPanel(
    ...
    private void addFormFieldRow(JPanel pane, int gridRow, JLabel label,
            JComponent field, boolean fill) {
    ...
    public void showConnectionErrorDialog(final String message) {
        ...
        final JDialog errorDialog = errorPane.createDialog(view,
                "Connection error");
