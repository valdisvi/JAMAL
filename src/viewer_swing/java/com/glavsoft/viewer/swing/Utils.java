...
public class Utils {
	...
	private static List<Image> getApplicationIcons() {
		...
		URL resource = Utils.class.getResource("watermelon_jamal_16x16.png");
		...
		resource = Utils.class.getResource("watermelon_jamal_32x32.png");
	...
	public static ImageIcon getButtonIcon(String name) {
		URL resource = Utils.class.getResource("button-"+name+".png");
    ...
    public static Cursor getCursor(LocalMouseCursorShape cursorShape) {
        ...
        URL resource = Utils.class.getResource("cursor-"+name+".png");
        if (resource != null) {
